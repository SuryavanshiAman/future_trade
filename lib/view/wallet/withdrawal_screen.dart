              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    const Text("1000" ,
                      style: TextStyle(fontWeight: FontWeight.w500,color: GameColor.white,fontSize: 16),
                    ),
                    Container(
                      height: 15,
                      width: 20,
                                  ...
                                  children: [
                                    Card(
                                      ...
                                      shape: RoundedRectangleBorder(
                                          side: BorderSide(color: GameColor.purple),
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                border:  OutlineInputBorder(
                                  borderSide: BorderSide(color: GameColor.purple),
                ...
                ConstantButton(
                    onTap: () {
                      if(amount.text.isEmpty){
                        Utils.show("Enter Amount",color: GameColor.gameRed, context);
                      }else if(password.text.isEmpty){
                        Utils.show("Enter Password ",color: GameColor.gameRed, context);
                      }else{
                        Utils.show("Amount withdrawal successfully",color: GameColor.lightGreen, context);
                      }
