          ...
          children: [
            ...
            Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Image.asset(Assets.imagesSalary),
                ),
                ...
                RichText(
                  ...
                  text: const TextSpan(
                    style: TextStyle(
                        fontSize: 16, color: GameColor.white),
                    children: [
                      TextSpan(
                          text: "1.",
                      ),
                      TextSpan(
                        text: ' Add minimum 2 downline with the fund of 6 Lacs.',
                        style: TextStyle(
                          color: GameColor.white,
                          fontWeight: FontWeight.w600,
                        ),
                ...
                RichText(
                  ...
                  text: const TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                        text: ' For carry on salary extra 10% value of weaker doownline.',
                        style: TextStyle(
                          color: GameColor.white,
                          fontWeight: FontWeight.w600,
                        ),
