...
import 'package:future_trade/res/bubble_animation/circular_painter.dart';
import 'package:future_trade/res/bubble_animation/runner.dart';
...
class Particles extends StatefulWidget {
  Particles({
    ...
    this.awayRadius = 100,
    this.awayAnimationDuration = const Duration(seconds: 1000),
